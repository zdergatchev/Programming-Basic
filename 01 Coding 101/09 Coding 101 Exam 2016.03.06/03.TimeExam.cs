...
namespace _03.TimeExam
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var examTime = examHours * 60 + examMinutes;            // Convert hours in minutes
            var studentTime = studentHours * 60 + studentMinutes;   // Convert hours in minutes
            var minutesDifference = studentTime - examTime;         // difference in minutes
